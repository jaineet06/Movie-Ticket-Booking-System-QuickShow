...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <button onClick={() => nav('/movies')} className="flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bg-primary-dull rounded-full font-medium cursor-pointerointer">Explore More <ArrowRight className="w-5 h-5"/> </button>
    </div>
  );
};
