    ...
    <>
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md">
          ...
          <input min={0} type="number" value={showPrice} onChange={(e) => setShowPrice(e.target.value)} className="outline-none" placeholder="Enter Show Price"/>
        </div>
      </div>
