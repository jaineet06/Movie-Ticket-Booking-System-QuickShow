    ...
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <div className="flex items-center flex-wrap gap-4 mt-4">
            ...
            <a
              href="#dateSelect"
              className="px-10 py-3 text-sm bg-primary hover:bg-primary-dull transform rounded-md font-medium cursor-pointer active:scale-95"
            >
              Buy Tickets
            </a>
      ...
      <div className="flex justify-center mt-20">
        <button onClick={() => {
          nav('/movies');
          scrollTo(0, 0);
        }} className="px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md cursor-pointer">Show More</button>
      </div>
    </div>
  ) : (
    <div>
